...
// let findById = Number(prompt("Enter Id"));
// let foundProduct = {};
// for (let i = 0; i < products.length; i++) {
//   if (products[i].id === findById) {
...
//   for (let i = 0; i < products.length; i++) {
//     let element = products[i].id;
//     if(productId === element) {
//       return products[i];
//     } 
//   }
//   return "This product not in your list"
// }
// console.log(getProductById(products, Number(prompt("Enter Id"))));
